...
<?php
        ...
        if(empty($getpresetcards) && $totalcustomcards != 0) {
            $totalcardsofset = $totalcustomcards;
        } else if($totalcustomcards == 0 && !empty($getpresetcards)) {
            $totalcardsofset = $totalpresetcards;
        } else if(!empty($getpresetcards) && $totalcustomcards != 0) {
                ...
                <div id="set-id-<?= $cardsetid ?>" class="text-center flashcard_set-container">
                    ...
                    <div id="fc--swiper" class="swiper-wrapper">
                        <!-- Slides | Start the Loop -->
                            ...
                            <?php } ?>
                        <!-- Preset Cards Loop -->
                            <?php if(!empty($getpresetcards)) { ?>
                                <?php $row = 1; while ( $presetcards->have_posts() ) : $presetcards->the_post(); ?>
                                <div class="fc-item card-fc-item swiper-slide">
                                        <div class="item">
